...
const Upload = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        formDataToSend.append("name", localStorage.getItem('formName') || '');
        formDataToSend.append("university", localStorage.getItem('formUniversity') || '');
        formDataToSend.append("designation", localStorage.getItem('formDesignation') || '');
        formDataToSend.append("machine_used", localStorage.getItem('formMachineUsed') || '');
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                // Store upload_id in sessionStorage
                ...
                localStorage.removeItem('formUniversity');
                localStorage.removeItem('formDesignation');
                localStorage.removeItem('formMachineUsed');
            } else {
