...
const FullscreenChart = ({
    ...
    return (
        <div
            ...
            className={`flex flex-col items-center justify-evenly p-4 w-full ${isFullScreen ? 'fixed inset-0 bg-white z-50' : ''} ${className}`}
        >
            ...
            <div className="flex items-center justify-center w-full h-full hover:border-0 relative">
                <div
                    ref={chartContentRef}
                    className={`w-full relative ${isFullScreen ? 'h-screen pt-12 pb-4' : ''}`}
                >
...
// const FullscreenChart = ({ children, title, className = '', downloadOptions = {}, surplusActionButtons = [] }) => {
//     const [isFullScreen, setIsFullScreen] = useState(false);
//     const chartContainerRef = useRef(null);
//     const chartContentRef = useRef(null);
...
//             className={`flex flex-col items-center justify-evenly p-4 w-full ${isFullScreen ? 'fixed inset-0 bg-white z-50' : ''} ${className}`}
//         >
//             {title && <div className="w-full"><h2 className="text-2xl text-center font-semibold mt-4 mb-4">{title}</h2><hr className='' /></div>}

//             <div>
//                 <div className="absolute top-5 right-5 z-20 pointer-events-auto flex flex-row items-center space-evenly">
//                     <button
//                         onClick={handleDownloadChart}
//                         className='bg-transparent p-2 border-0 rounded-md hover:text-gray-500 hover:outline-none outline-none transition-all'
...
//                     >
//                         {isFullScreen ? (
//                             // compress-arrows-alt icon (when in fullscreen)
//                             <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
//                                 <path fillRule="evenodd" d="M5 4a1 1 0 0 1 1-1h4a1 1 0 1 1 0 2H7.414l6.293 6.293a1 1 0 0 1-1.414 1.414L6 6.414V9a1 1 0 1 1-2 0V5a1 1 0 0 1 1-1zm10 12a1 1 0 0 1-1 1h-4a1 1 0 1 1 0-2h2.586l-6.293-6.293a1 1 0 0 1 1.414-1.414L14 13.586V11a1 1 0 1 1 2 0v4a1 1 0 0 1-1 1z" clipRule="evenodd" />
//                             </svg>
//                         ) : (
//                             // expand-arrows-alt icon (when not in fullscreen)
//                             <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 512 512" fill="currentColor">
//                                 <path d="M448 344v112a23.94 23.94 0 0 1-24 24H312c-21.39 0-32.09-25.9-17-41l36.2-36.2L224 295.6 116.77 402.9 153 439c15.09 15.1 4.39 41-17 41H24a23.94 23.94 0 0 1-24-24V344c0-21.4 25.89-32.1 41-17l36.19 36.2L184.46 256 77.18 148.7 41 185c-15.1 15.1-41 4.4-41-17V56a23.94 23.94 0 0 1 24-24h112c21.39 0 32.09 25.9 17 41l-36.2 36.2L224 216.4l107.23-107.3L295 73c-15.09-15.1-4.39-41 17-41h112a23.94 23.94 0 0 1 24 24v112c0 21.4-25.89 32.1-41 17l-36.19-36.2L263.54 256l107.28 107.3L407 327.1c15.1-15.2 41-4.5 41 16.9z" />
//                             </svg>
//                         )}
...
//                         <div
//                             className="text-[#1c1e20] opacity-10 text-6xl font-bold whitespace-nowrap top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
//                             style={{ transform: 'rotate(-30deg)', maxWidth: 'none' }}
//                         >
//                             {'NYU-ViscoMOD-Capturing'}
//                         </div>
//                     </div>
...
//                 {/* Chart content with dynamic height based on fullscreen state */}
//                 <div ref={chartContentRef} className="relative z-10 w-full pointer-events-auto" style={{ height: isFullScreen ? 'calc(100vh - 8rem)' : 'auto' }}>
//                     {React.cloneElement(children, {
//                         height: isFullScreen ? '100%' : children.props.height || 400
//                     })}
//                 </div>
//             </div>
//         </div>
